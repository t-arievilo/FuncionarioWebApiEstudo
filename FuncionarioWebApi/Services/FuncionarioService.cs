...
namespace FuncionarioWebApi.Services
{
    public class FuncionarioService : IFuncionarioService
    {
        ...
        public async Task<ServiceResponse<FuncionarioModel>> GetFuncionarioById(int id)
        {
            ...
            try
            {
                FuncionarioModel funcionario = _context.Funcionarios.FirstOrDefault(p => p.Id == id);
...

        {
            ...
            try
            {
                FuncionarioModel funcionario = _context.Funcionarios.AsNoTracking().FirstOrDefault(p => p.Id == editadoFuncionario.Id);
